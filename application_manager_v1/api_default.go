...
type DefaultApiGetDeploymentDetailsRequest struct {
	ctx context.Context
	ApiService *DefaultApiService
	xAnypntEnvId *string
	xAnypntOrgId *string
...
// The environment id where the application is deployed
func (r DefaultApiGetDeploymentDetailsRequest) XAnypntEnvId(xAnypntEnvId string) DefaultApiGetDeploymentDetailsRequest {
	r.xAnypntEnvId = &xAnypntEnvId
	return r
}

// The org id where the application is deployed
func (r DefaultApiGetDeploymentDetailsRequest) XAnypntOrgId(xAnypntOrgId string) DefaultApiGetDeploymentDetailsRequest {
	r.xAnypntOrgId = &xAnypntOrgId
	return r
}

func (r DefaultApiGetDeploymentDetailsRequest) Execute() (*DeploymentDetails, *http.Response, error) {
	return r.ApiService.GetDeploymentDetailsExecute(r)
}

/*
GetDeploymentDetails Read deployment details

Retrieve a single application by name. Requires 'Read Applications' role.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param domain The application domain in the path
 @return DefaultApiGetDeploymentDetailsRequest
*/
func (a *DefaultApiService) GetDeploymentDetails(ctx context.Context, domain string) DefaultApiGetDeploymentDetailsRequest {
	return DefaultApiGetDeploymentDetailsRequest{
		ApiService: a,
		ctx: ctx,
		domain: domain,
...
func (a *DefaultApiService) GetDeploymentDetailsExecute(r DefaultApiGetDeploymentDetailsRequest) (*DeploymentDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.GetDeploymentDetails")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r DefaultApiPostDeploymentRequest) Execute() (*DeploymentDetails, *http.Response, error) {
...
// Execute executes the request
//  @return DeploymentDetails
func (a *DefaultApiService) PostDeploymentExecute(r DefaultApiPostDeploymentRequest) (*DeploymentDetails, *http.Response, error) {
	var (
...
func (r DefaultApiPutDeploymentRequest) Execute() (*DeploymentDetails, *http.Response, error) {
...
// Execute executes the request
//  @return DeploymentDetails
func (a *DefaultApiService) PutDeploymentExecute(r DefaultApiPutDeploymentRequest) (*DeploymentDetails, *http.Response, error) {
	var (
