...
// checks if the DeploymentGroup type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentGroup{}

// DeploymentGroup Information about the deployment group to which this app belongs.
...
func (o DeploymentGroup) ToMap() (map[string]interface{}, error) {
