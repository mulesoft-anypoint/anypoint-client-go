...
// checks if the VCoresProductionEntitlement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCoresProductionEntitlement{}

// VCoresProductionEntitlement struct for VCoresProductionEntitlement
type VCoresProductionEntitlement struct {
	// VCores Production assigned
	Assigned *float32 `json:"assigned,omitempty"`
	// VCores Production reassigned
...
func NewVCoresProductionEntitlement() *VCoresProductionEntitlement {
	this := VCoresProductionEntitlement{}
...
func (o VCoresProductionEntitlement) MarshalJSON() ([]byte, error) {
...
func (o VCoresProductionEntitlement) ToMap() (map[string]interface{}, error) {
...
type NullableVCoresProductionEntitlement struct {
	value *VCoresProductionEntitlement
	isSet bool
}

func (v NullableVCoresProductionEntitlement) Get() *VCoresProductionEntitlement {
	return v.value
}

func (v *NullableVCoresProductionEntitlement) Set(val *VCoresProductionEntitlement) {
	v.value = val
	v.isSet = true
}

func (v NullableVCoresProductionEntitlement) IsSet() bool {
	return v.isSet
}

func (v *NullableVCoresProductionEntitlement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVCoresProductionEntitlement(val *VCoresProductionEntitlement) *NullableVCoresProductionEntitlement {
	return &NullableVCoresProductionEntitlement{value: val, isSet: true}
}

func (v NullableVCoresProductionEntitlement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVCoresProductionEntitlement) UnmarshalJSON(src []byte) error {
	v.isSet = true
